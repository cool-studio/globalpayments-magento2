define(
    ...
    function(
        ...
        return {
            ...
            requirePaymentFields: function (caller) {
                return function (onComplete) {
                    var code = caller.getCode();
                    if (code === 'globalpayments_paymentgateway_txnapi') {
                        require(['https://js.paygateway.com/secure_payment/v1/globalpayments.js'], onComplete);
                    } else {
                        require(['https://js.globalpay.com/v1/globalpayments.js'], onComplete);
                    }
                }
            },
