...
define([
    ...
    'mage/translate',
    // 'GlobalPayments_PaymentGateway/js/vault-enabler',
    'https://js.globalpay.com/v1/globalpayments.js',
    'domReady!'
], function (require,$, Class, alert, $t, /*VaultEnabler, */ GlobalPayments) {
    'use strict';
    ...
    return Class.extend({
         ...
         * @returns
         */
        requirePaymentFields: function (callback) {
            var code = this.getCode();
            if (code === 'globalpayments_paymentgateway_txnapi') {
                require(['https://js.paygateway.com/secure_payment/v1/globalpayments.js'], callback);
            } else {
                require(['https://js.globalpay.com/v1/globalpayments.js'], callback);
            }
        },
        ...
        renderPaymentFields: function () {
            var self = this;
            this.requirePaymentFields(function(GlobalPayments) {
                if (!window.GlobalPayments) {
                    window.GlobalPayments = GlobalPayments;
                }
                console.log('Require globalpayments succeeded');
                self.doRenderPaymentFields();
            })
        },
        ...
        normalizeResponseForTransactionApi(response){
            return {
        ...
        prepareForOrderSubmission(response){
        ...
        doRenderPaymentFields: function(){
